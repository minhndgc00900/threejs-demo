  ...
  return (
      <div className="section-container p-2">
        ...
        <div className="flex flex-row gap-2">
          ...
          <div className="">
            <h2
              className="text-[38px] cursor-pointer text-shadow-[0px_0px_10px_rgba(0,0,0,0.5)]"
              style={{
                color: getColorByPollution(
                  factory.pollutionLevel,
                  true
                ) as string,
              }}
            ...
            <p
              className="text-[18px] text-shadow-[0px_0px_10px_rgba(0,0,0,0.5)]"
              style={{
                color: getColorByPollution(
                  factory.pollutionLevel,
                  true
